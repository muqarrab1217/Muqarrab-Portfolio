...
const socialLinks = [
  {
    href: 'https://github.com/muqarrab1217',
  ...
  {
    href: 'https://www.linkedin.com/in/muqarrab-ahmed/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://learn.microsoft.com/en-us/?WT.mc_id=academic&wt.mc_id=studentamb_358934',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/muqarrab._.malik/',
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bjjjqezb"
          method="POST"
